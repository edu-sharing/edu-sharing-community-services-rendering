...
function run($installedVersion) {
	...
	try {
        ...
        if(version_compare ( '5.1', $installedVersion ) > 0) {
            ...
            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESMODULE` DROP `ESMODULE_DESC`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESOBJECT` DROP `ESOBJECT_ESAPPLICATION_ID`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESOBJECT` DROP `ESOBJECT_LMS_ID`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESOBJECT` DROP `ESOBJECT_COURSE_ID`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESOBJECT` DROP `ESOBJECT_VERSIONED_OBJECT_ID`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESOBJECT` DROP `ESOBJECT_RESOURCE_ID`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESOBJECT` DROP `ESOBJECT_FILE_PATH`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESOBJECT_CONVERSION` DROP `ESOBJECT_CONVERSION_DIR_SEPERATOR`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESOBJECT_CONVERSION` DROP `ESOBJECT_CONVERSION_RENDER_PATH`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();

            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESTRACK` DROP `ESTRACK_APP_ID`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESTRACK` DROP `ESTRACK_REP_ID`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESTRACK` DROP `ESTRACK_LMS_COURSE_ID`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESTRACK` DROP `ESTRACK_OBJECT_ID`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESTRACK` DROP `ESTRACK_NAME`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESTRACK` DROP `ESTRACK_MODUL_ID`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESTRACK` DROP `ESTRACK_MODUL_NAME`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESTRACK` DROP `ESTRACK_VERSION`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESTRACK` DROP `ESTRACK_USER_NAME`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESTRACK` DROP `ESTRACK_USER_ID`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `ESTRACK` DROP `STATE`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();

            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `VERSION_IDENT`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `VERSION_NAME`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `VERSION_DESC`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `VERSION_REVISION`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `VERSION_VBUILD`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `VERSION_PATCH`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `VERSION_AUTHOR`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `VERSION_URI`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `OWNER`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `WGROUP`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `ACCESS`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `COURSE_ID`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `DS_ID`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `VIEW`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `LAYOUT`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `RELSTATE`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `RELLANG`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `RELUSER`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `RELDATE`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `INSDAT`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `UPDDAT`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `UPDUSER`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
            $sql = $pdo->formatQuery ( 'ALTER TABLE `VERSION` DROP `STATE`');
            $stmt = $pdo->prepare ( $sql );
            $stmt->execute ();
