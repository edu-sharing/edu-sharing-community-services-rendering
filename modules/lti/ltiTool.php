...
class ltiTool {
    ...
    private function getLaunchForm($requestData) {
        ...
        $launch_data = array();
        $launch_data["roles"] = $this -> esobject -> ContentNode -> getProperty('ccm:tool_instance_roles');
        $launch_data["params"] = $this -> esobject -> ContentNode -> getProperty('ccm:tool_instance_params');
        ...
        $launch_data["oauth_consumer_key"] = $this -> esobject -> ContentNode -> getProperty('ccm:tool_instance_key');
        ...
        $base_string = "POST&" . urlencode($this -> esobject -> ContentNode -> getProperty('ccm:wwwurl')) . "&" . rawurlencode(implode("&", $launch_params));
        $secret = urlencode($this -> esobject -> ContentNode -> getProperty('ccm:tool_instance_secret')) . '&';
        ...
        $form = '<html>
            ...
            <body onload="document.ltiLaunchForm.submit();">
                ...
                method="POST" action="' . $this -> esobject -> ContentNode -> getProperty('ccm:wwwurl') . '" target="lti_frame_'.$this->esobject->getObjectID().'">';
