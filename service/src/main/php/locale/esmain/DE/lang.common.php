...
$Translate
	...
	->addTranslation('de', 'An internal server error occurred.', 'Ein Fehler ist aufgetreten.')
    ...
    ->addTranslation('de', 'urls empty', ' - die Antwort enthält leere streamURL und leere downloadURL')
    ...
    ->addTranslation('de', 'dataProtectionExternalHeading', 'Externe Seite')
    ...
    ->addTranslation('de', 'dataProtectionExternalDescription', 'Beim Öffnen der externen Seite werden möglicherweise Daten übertragen. Bitte beachten Sie unsere ')
